...
public class test extends JFrame{
	public static final int GRID_SIZE=9;															//Grundvariablen für Sudoku
	...
	public test(int mask[][],int puzzle[][]){
		...
		for(int row = 0;row<GRID_SIZE;++row){
			for (int col = 0; col < GRID_SIZE; ++col) {
				...
				if(mask[row][col]==0){																					//Sudoku Gitter wird ausgefüllt				
	 ...
	 private class InputListener implements ActionListener {																	//Event schaut, ob Zahlen in das Sudoku eingefüllt werden und färbt sie entsprechend
